...
def split_chunks(texto, tamanho=1000):
    chunks = []
...
def search_conhecimento(question, conhecimento):
    STOPWORDS = [
        "a", "o", "os", "as",
        "de", "do", "da", "dos", "das",
        "qual", "quais", "que",
    ...
    chunks = split_chunks(conhecimento, 1000)
    ...
    for i, chunk in enumerate(chunks):
        ...
        chunk_lower = unidecode(chunk.lower())
