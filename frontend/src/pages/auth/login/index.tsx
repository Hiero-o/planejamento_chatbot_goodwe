    ...
    return (
        <main className="flex items-center justify-center flex-col min-h-[100vh]">
            <form className="flex items-center justify-center flex-col w-[300px]" onSubmit={codeSent ? handleLoginUser : handleRequestCode}>
                ...
                <button disabled={loading} type='submit' style={loading ? { backgroundColor:'#a0a0a0', border: '1px solid #a0a0a0', }: {}} className="mb-[15px] w-full rounded-[8px] py-[6px] px-[15px] text-[14px] bg-[#ECFF00] text-[#070707] font-semibold cursor-pointer transition-[0.2s] hover:bg-[#89920d]">
                    {loading ? (
                        <>
                            Carregando
                        </>
